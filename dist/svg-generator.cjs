...
var ZCarpetCleaningIcon = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_react_native_svg2.default, { width: size, height: size, viewBox: "0 0 256 256", fill: "none", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react_native_svg2.Path, { d: "M157.842 115.491V33C157.842 31.8954 158.737 31 159.842 31H228.263C229.367 31 230.263 31.8954 230.263 33V212.053M230.263 212.053H218.193M230.263 212.053H242.333", stroke: color, strokeWidth, strokeLinecap: "round" })
  ] });
};
