...
const ZMagicWandIconWeb: React.FC<IconProps> = ({
  ...
  return (
        <svg width={size} height={size} viewBox="0 0 256 256" fill="none">
            ...
            <path d="M207.5 138.66C208.656 141.262 210.737 143.344 213.339 144.5C210.737 145.656 208.656 147.737 207.5 150.339C206.344 147.737 204.262 145.656 201.66 144.5C204.263 143.344 206.344 141.263 207.5 138.66Z" stroke={color} strokeWidth={strokeWidth} fill={color}/>
            <path d="M176.5 181.66C177.656 184.262 179.737 186.344 182.339 187.5C179.737 188.656 177.656 190.737 176.5 193.339C175.344 190.737 173.262 188.656 170.66 187.5C173.263 186.344 175.344 184.263 176.5 181.66Z" stroke={color} strokeWidth={strokeWidth} fill={color}/>
            ...
            <path d="M39.1382 180.007L136.719 82.4266L172.781 118.489L75.2006 216.07C72.8574 218.413 69.0585 218.413 66.7153 216.07L39.1381 188.493C36.795 186.149 36.795 182.351 39.1382 180.007Z" stroke={color} strokeWidth={strokeWidth} fill={color}/>
        </svg>
  );
